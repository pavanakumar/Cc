...
void Cycle(CtrlType *ctrl, GraphType *graph, int npasses)
{
   ...
   IMfree((void **)(&graph->pwgts), (void **)(&graph->pvol), (void **)(&graph->psurf), LTERM);
...
void Merge_ARatio(CtrlType *ctrl, GraphType *graph)
{
  ...
  IMfree((void **)(&ptr), (void **)(&ind), (void **)(&psurf), (void **)(&pvol),
         (void **)(&pwgts), (void **)(&elpairs), (void **)(&ptarget),
         (void **)(&degrees), (void **)(&phtable), LTERM);
}
...
void Merge_WeightARatio(CtrlType *ctrl, GraphType *graph)
{
  ...
  IMfree((void **)(&ptr), (void **)(&ind), (void **)(&psurf), (void **)(&pvol),
         (void **)(&pwgts), (void **)(&elpairs), (void **)(&ptarget), (void **)(&degrees), 
         (void **)(&phtable), LTERM);
}
...
void Merge_MultiObj(CtrlType *ctrl, GraphType *graph)
{
  ...
  IMfree((void **)(&ptr), (void **)(&ind), (void **)(&psurf), (void **)(&pvol), (void **)(&pwgts),
         (void **)(&elpairs), (void **)(&ptarget), (void **)(&degrees), (void **)(&phtable), LTERM);
}
...
void Contribute_MultiObj(CtrlType *ctrl, GraphType *graph)
{
  ...
  if (nsels == 0) {
    graph->nmoves=-1;
    IMfree((void **)(&ptr), (void **)(&ind), (void **)(&psurf), (void **)(&pvol), (void **)(&pwgts), (void **)(&elpairs), LTERM);
    return;
  }

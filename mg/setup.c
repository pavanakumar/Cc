...
{
  IMfree((void **)(&graph->xadj), (void **)(&graph->vwgt), (void **)(&graph->vvol), (void **)(&graph->vsurf),
              (void **)(&graph->adjncy), (void **)(&graph->adjwgt), (void **)(&graph->adjwgtsum), 
              (void **)(&graph->cmap), (void **)(&graph->where), (void **)(&graph->pwgts), (void **)(&graph->pvol),
              (void **)(&graph->psurf), LTERM);
